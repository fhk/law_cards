...
CARD_HEIGHT     = 82
CARD_WIDTH      = 81
CARDS_PER_PAGE  = 4 # NUmber of cards on a single page
...
def create_doc(input_dict):
    ...
    for item in range(0, len(input_dict)):
        ...
        flash_card_back_content_list.append(flash_item_values[1][:600].replace(
            'Definition', 'Definition: ').replace('Illustrative caselaw', 'Illustrative caselaw: '))
        ...
        if (len(flash_card_front_content_list) == CARDS_PER_PAGE and len(flash_card_back_content_list) == CARDS_PER_PAGE):
            ...
            for front_row_item in range(0, len(flash_card_front_content_list)):
                if (front_row_item % 4) == 0 and front_row_item > 0:
            ...
            for back_row_item in range(0, len(flash_card_back_content_list)):
                ...
                if (back_row_item % 4) == 0:
                    back_row_1 = []
                    row = back_table.add_row()
                    back_row_1.append(flash_card_back_content_list[back_row_item + 2])
                    back_row_1.append(flash_card_back_content_list[back_row_item + 3])

                    back_row_2 = []
                    row = back_table.add_row()
                    back_row_2.append(flash_card_back_content_list[back_row_item])
                    back_row_2.append(flash_card_back_content_list[back_row_item + 1])
                    add_centered_row(back_table.rows[0].cells, back_row_1)
                    add_centered_row(back_table.rows[1].cells, back_row_2)
